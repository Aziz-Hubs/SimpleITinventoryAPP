...
import { ChevronDown, ChevronLeft, ChevronRight, Search, Settings2, Trash2 } from "lucide-react";
...
export function BaseDataTable<TData, TValue>({
    ...
    return (
        <div className="space-y-4">
                    ...
                    {searchKey && (
                        <div className="relative group w-full sm:w-auto">
                            ...
                            <Input
                                ...
                                className="h-10 w-full sm:w-[250px] pl-10 bg-muted/30 border-none focus-visible:ring-1 focus-visible:ring-primary/50 transition-all shadow-inner"
                            />
                        </div>
                    )}
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button
                                variant="outline"
                                size="sm"
                                className="h-10 px-3 bg-muted/20 border-border/50 w-full sm:w-auto ml-auto sm:ml-0"
                            >
            ...
            {/* Table Container */}
            <div className="rounded-xl border border-border/50 bg-card shadow-sm overflow-hidden grid grid-cols-1">
                <Table>
