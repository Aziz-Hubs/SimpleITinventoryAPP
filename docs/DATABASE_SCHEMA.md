...
- **ReportedDate**: `DateTimeOffset`
- **ScheduledDate**: `DateTimeOffset` (Nullable)
...
System-wide audit trail for dashboard and history.

- **Id**: `INT` (PK, Identity)
- **UserId**: `NVARCHAR(255)` (FK -> Employees)
- **Action**: `NVARCHAR(100)` (e.g., "Updated Asset")
- **Target**: `NVARCHAR(200)` (e.g., "Asset-1023")
- **Timestamp**: `DateTimeOffset`
- **Comment**: `NVARCHAR(MAX)` (Optional details)
...
- **`IX_ActivityLogs_TenantId_Timestamp`**: Fast retrieval of recent activities.
